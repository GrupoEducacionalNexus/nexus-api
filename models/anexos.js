                        ...
                        conexao.query(
                            sql,
                            {
                                ...
                                if (erro) {
                                    ...
                                    enviarEmail(
                                        `${email_orientador.trim()}`,
                                        "Mensagem sobre anexo de arquivo!",
                    ...
                    conexao.query(
                        sql,
                        {
                            ...
                            if (erro) {
                                ...
                                res.status(200).json({
                                    status: 200,
                                    msg: "Anexo cadastrado com sucesso"
                                });
                            }
                        });
                }
